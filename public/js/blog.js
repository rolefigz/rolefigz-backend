...
function renderDettaglioArticolo(a) {
  ...
  wrap.innerHTML = `
    <button class="action-btn" onclick="mostraVista('blog');loadArticoli()" style="margin-bottom:32px">← TORNA AL BLOG</button>
    ...
    <div style="margin-top:48px;padding-top:32px;border-top:1px solid var(--border)">
      <button class="action-btn" onclick="mostraVista('blog');loadArticoli()">← TORNA AL BLOG</button>
    </div>`;
}
