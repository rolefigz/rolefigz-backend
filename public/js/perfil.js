...
function tradStatoIT(e) {
  return { pendiente: 'IN ATTESA', confirmado: 'CONFERMATO', enviado: 'SPEDITO', entregado: 'CONSEGNATO', cancelado: 'ANNULLATO' }[e] || e.toUpperCase();
}

function renderOrdineProfilo(o) {
  const STEPS = [
    { key: 'confirmado', label: 'Confermato',  icon: '✓' },
    { key: 'confirmado', label: 'In lavorazione', icon: '⚙' },
  ...
  return `
    <div class="ocv2">
      <div class="ocv2-header">
        ...
        <span class="pill ${pillStato(o.estado)}">${tradStatoIT(o.estado)}</span>
      </div>
      <div class="ocv2-body">
        <div class="ocv2-main">
          ${stepperHtml}
